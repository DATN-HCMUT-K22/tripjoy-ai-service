...
{{
  "summary": "Tóm tắt chuyên sâu về đích đến (2-3 đoạn), bao gồm lịch sử, địa lý, văn hoá đặc trưng",
  ...
  "culture": "Những đặc điểm văn hóa nổi bật, tập quán địa phương, quy tắc ứng xử, ẩm thực đặc sắc, lễ hội và sự kiện quan trọng"
}}
