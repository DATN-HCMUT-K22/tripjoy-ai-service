...
def main():
    ...
    for i in range(n):
        ...
        avg.avg_spatial_coherence += travel_requests[i]["subscores"][
            "spatial_coherence"
        ]
        avg.avg_temporal_feasibility += travel_requests[i]["subscores"][
            "temporal_feasibility"
        ]
        avg.avg_poi_relevance_travel_type += travel_requests[i]["subscores"][
            "poi_relevance_travel_type"
        ]
        avg.avg_poi_relevance_budget += travel_requests[i]["subscores"][
